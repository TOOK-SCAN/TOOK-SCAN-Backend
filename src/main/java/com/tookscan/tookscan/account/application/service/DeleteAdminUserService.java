...
public class DeleteAdminUserService implements DeleteAdminUserUseCase {
    ...
    @BusinessLog(
        ...
        action = "delete users",
        userType = "Admin",
        startDetails = {"user_ids: #requestDto.userIds()", "user_count: #requestDto.userIds().size()"},
        endDetails = {"deleted_user_ids: #requestDto.userIds()", "deleted_user_count: #requestDto.userIds().size()"}
    )
