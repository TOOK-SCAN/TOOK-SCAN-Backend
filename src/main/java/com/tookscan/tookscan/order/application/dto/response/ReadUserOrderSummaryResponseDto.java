...
@Getter
public class ReadUserOrderSummaryResponseDto extends SelfValidating<ReadUserOrderSummaryResponseDto> {
    ...
    @Builder
    public ReadUserOrderSummaryResponseDto(String orderNumber, String orderDate, String receiverName,
    ...
    public static ReadUserOrderSummaryResponseDto fromEntity(Order order, Integer defaultPrice) {
        return ReadUserOrderSummaryResponseDto.builder()
