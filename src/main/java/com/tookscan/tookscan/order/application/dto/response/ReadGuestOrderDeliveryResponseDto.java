...
@Getter
public class ReadGuestOrderDeliveryResponseDto extends SelfValidating<ReadGuestOrderDeliveryResponseDto> {
    ...
    @Builder
    public ReadGuestOrderDeliveryResponseDto(String trackingNumber, String carrierName, EDeliveryStatus deliveryStatus,
    ...
    public static ReadGuestOrderDeliveryResponseDto of(Order order, List<Map<String, Object>> trackingResponse,
                                                       String carrierName) {
        ...
        return ReadGuestOrderDeliveryResponseDto.builder()
